<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.master" AutoEventWireup="true" CodeBehind="LogCargo.aspx.cs" Inherits="Trazabilidad.LogCargo" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 style="font-size:15px">Reporte de trazabilidad de cargos</h1>
    ...
    <asp:GridView ID="gvCargos" runat="server" AutoGenerateColumns="False" Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="1" AllowPaging="true" PageSize="30" OnPageIndexChanging="gvCargos_PageIndexChanging">
        <Columns>            
            ...
            <asp:BoundField DataField="centralrecieveuser" HeaderText="Central" ItemStyle-HorizontalAlign="Center" />
