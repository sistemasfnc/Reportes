<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.master" AutoEventWireup="true" CodeBehind="CargosOtros.aspx.cs" Inherits="Trazabilidad.CargosOtros" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 style="font-size:15px">Cargar plantilla otros servicios</h1>
    <asp:Wizard ID="Wizard1" runat="server" DisplaySideBar="false" ActiveStepIndex="0" OnNextButtonClick="Wizard1_NextButtonClick" Width="70%">
        ...
        <WizardSteps>
            <asp:WizardStep ID="WizardStep1" runat="server">
                <div>
                    Cargar archivo de ingresos de otros servicios</div>
                <br />
