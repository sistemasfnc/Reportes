<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.master" AutoEventWireup="true" CodeBehind="RecibirRelacion.aspx.cs" Inherits="Trazabilidad.RecibirRelacion" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 style="font-size:15px">Recibir relaci&oacute;n de env&iacute;o</h1>      
        ...
        <ContentTemplate>
            <asp:GridView ID="gvRelaciones" runat="server" AutoGenerateColumns="False" Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="1" OnRowCommand="gvRelaciones_RowCommand" AllowPaging="true" PageSize="50" OnPageIndexChanging="gvRelaciones_PageIndexChanging">
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="# Recibido">
                        <ItemTemplate>
                            <asp:Label ID="lblId" Text='<%# ShowText(Eval("cestado"), Eval("iid")) %>' runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:ImageButton ID="imbTramitar" runat="server" ToolTip="Tramitar" ImageUrl="~/images/list.png" Width="18" Height="18" CommandName="Tramitar" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="pnValidar" runat="server" CssClass="modalPopup" Style="position: absolute; display:none;">
                <asp:Panel ID="pnlMensaje" runat="server" style="font-size:small">
                    ...
                    <div style="font-weight:bold">Facturas a recibir</div><br />
                    <asp:GridView ID="gvFacturas" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="false" Width="100%" AllowPaging="true" PageSize="20" OnPageIndexChanging="gvFacturas_PageIndexChanging" OnRowDataBound="gvFacturas_RowDataBound">
                        <Columns>
                            <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                <HeaderTemplate>
                                ...
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkSeleccionar" runat="server" Visible='<%# EnableCheck(Eval("ienviado"), Eval("irecibido")) %>' />
                                </ItemTemplate>
                    ...
                    <br />
                     <table style="font-size:small">
                        <tr>
                            ...
                            <td style="vertical-align:top">
                                 <asp:GridView ID="gvObservaciones" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="false" Width="100%">
                                    <Columns>
                    ...
                    <br />
                    <div>
                        <asp:ImageButton ID="imbEnviar" runat="server" ImageUrl="~/images/diskette.png" ToolTip="Guardar" Width="48" Height="48" OnClick="imbEnviar_Click" />
                    </div>
                </asp:Panel>
            </asp:Panel>
