...
{
    public partial class LogCargo : System.Web.UI.Page
    {
        private User oUser
        {
        ...
        {
            get { return (Session["lCargo"] != null) ? Session["lCargo"] as List<Entity.Devolucion> : new List<Entity.Devolucion>(); }
            set { Session["lCargo"] = value; }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                if (!Tools.HaveAccess(this.oUser.lSecurity, (int)Permissions.logreport))
                {
        ...
        private void BindGrid()
        {
            ...
            try
            {
                ...
                this.lReturn = oFacade.GetListStatus(oCargo);
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "", @"window.open('ExportarLogCargos.aspx');", true);
        }
    }
}