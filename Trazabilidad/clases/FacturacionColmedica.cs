...
{
    public class FacturacionColmedica : IDisposable
    {
        ...
        /*private void CreatePDFSupports(List<Generic> lgeneric, string sinvoice)
        {
            ...
            string[] paths = new string[] { Configuration.GetStringValue("RelationshipsFolder"), this.sRelation, "SOPORTES", "SETT" + sinvoice + ".pdf" };
            ...
            if (lgeneric.Count > 0)
            {
                ...
                document.Close();
                paths = new string[] { Configuration.GetStringValue("RelationshipsFolder"), this.sRelation, "SOPORTES", "SETT" + sinvoice + ".pdf" };
        ...
        */
        ...
        private void CreatePDFSupports(List<Generic> lgeneric, string sinvoice)
        {
            string[] paths = new string[] { Configuration.GetStringValue("RelationshipsFolder"), this.sRelation, "SOPORTES", "SETT" + sinvoice + "-1.pdf" };
            string pdffile = Path.Combine(paths);
            List<string> lsupports = null;
