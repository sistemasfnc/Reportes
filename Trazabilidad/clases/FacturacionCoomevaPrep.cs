...
{
    public class FacturacionCoomevaPrep : IDisposable
    {
        ...
        public void GenerateFiles(List<Desmaterializacion> ldesmaterializacion)
        {
            ...
            foreach (var item in result)
            {
                ...
                sfilename.Append("_");
                sfilename.Append(item.total.ToString());                
        ...
        private void GeneratePDF(List<Desmaterializacion> ldesmaterializacion, string sinvoice, string sfile, string sname)
        {
            ...
            {
                string[] paths = new string[] { Configuration.GetStringValue("RelationshipsFolder"), this.sRelation, sname, "IMGFACTURA.pdf" };
