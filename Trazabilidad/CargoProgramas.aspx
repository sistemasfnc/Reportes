<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.master" AutoEventWireup="true" CodeBehind="CargoProgramas.aspx.cs" Inherits="Trazabilidad.CargoProgramas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 style="font-size:15px">Cargar plantilla ingresos</h1>
    <asp:Wizard ID="Wizard1" runat="server" DisplaySideBar="false" ActiveStepIndex="0" OnNextButtonClick="Wizard1_NextButtonClick" Width="70%">
        ...
        <WizardSteps>
            <asp:WizardStep ID="WizardStep1" runat="server">
                <div>
                    Cargar archivo de ingresos de programas</div>
                <br />
                <div style="text-align: justify">
                    <strong>PASO 1:</strong> Seleccione el tipo y archivo que desea cargar y haga clic en el bot&oacute;n "Siguiente".
                </div>
                <br />
                <div>
                    Tiene ingreso origen? 
                    <asp:DropDownList ID="ddlTipo" runat="server">
                        <asp:ListItem Selected="True" Text="No" Value="No"></asp:ListItem>
                        <asp:ListItem Text="Si" Value="Si"></asp:ListItem>
                    </asp:DropDownList>
                    &nbsp;Archivo <asp:FileUpload ID="fuArchivo" runat="server" />
                    ...
                    <Columns>
                       <asp:BoundField DataField="sdocumenttype" HeaderText="Tipo de documento" />
                        ...
                        <asp:TemplateField HeaderText="Plantilla">
                            <ItemTemplate>
                                <span><%# DataBinder.Eval(Container.DataItem, "lappointments[0].stemplate") %></span>
                            </ItemTemplate>
                        </asp:TemplateField>                          
                    </Columns>
            ...
            <asp:WizardStep ID="WizardStep3" runat="server">
                ...
                <asp:GridView ID="gvResultado" runat="server" AutoGenerateColumns="False" Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="1" AllowPaging="true" PageSize="50" OnPageIndexChanging="gvResultado_PageIndexChanging">
                    <Columns>
                        ...
                        <asp:BoundField DataField="stemplate" HeaderText="Plantilla" />
