<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.master" AutoEventWireup="true" CodeBehind="Devolucion.aspx.cs" Inherits="Trazabilidad.Devolucion" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 style="font-size:15px">Tramitar cargos devueltos</h1>
            ...
            <asp:Panel ID="pnValidar" runat="server" CssClass="modalPopup" Style="position: absolute; display:none;">
                <asp:Panel ID="pnlMensaje" runat="server">
                    ...
                    <asp:GridView ID="gvSoportes" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AutoGenerateColumns="false" Width="100%">
                        <Columns>                            
                            ...
                            <asp:TemplateField HeaderText="Respuesta">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtRespuesta" runat="server" TextMode="MultiLine" Text='<%# Eval("response") %>'></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField> 
                        </Columns>
                        <FooterStyle BackColor="White" ForeColor="#000066" />
                    ...
                    <div style="text-align:right">
                        <asp:ImageButton ID="imbSalvar" runat="server" ToolTip="Guardar" ImageUrl="~/images/diskette.png" Width="20" Height="20" OnClick="imbSalvar_Click" />&nbsp;
                        <asp:ImageButton ID="imbGuardar" runat="server" ToolTip="Enviar" ImageUrl="~/images/envelope.png" Width="20" Height="20" OnClientClick="return confirm('Esta seguro que desea reenviar este cargo?');" OnClick="imbGuardar_Click" />
                    </div>                
                </asp:Panel>
            </asp:Panel>
