...
{
    public partial class CargoFibrosis : System.Web.UI.Page
    {
        /// <summary>
        ...
        {
            Response.Redirect("~/CargoFibrosis.aspx");
        }
        ...
        protected void imbExportar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=ingresosfibrosis.xlsx");
