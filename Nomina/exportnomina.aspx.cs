...
namespace Nomina
{
    public partial class exportnomina : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["lNomina"] != null)
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=reportenomina.xls");
                this.gvDatos.DataSource = Session["lNomina"];
                this.gvDatos.DataBind();
                form.Controls.Add(this.gvDatos);
